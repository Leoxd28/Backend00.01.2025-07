...
document.getElementById("crearPedido").addEventListener("click", () => {
  ...
  switch (producto) {
    case "1":
      let tipoCafe = parseInt(
        prompt(`Dime tu tipo de cafe: 1=Americano, 2=Expreso, 3=Latte`)
      );
      ...
      break;
    case "2":
      let tipoPostre = parseInt(
        prompt("Dime tu postre: 1=Torta de Chocolate, 2=Criossant, 3=Triple")
      );
      switch (tipoPostre) {
        case 1:
...
function preguntarLeche(objCliente) {
  let respuesta = prompt(
    "Que tipo de leche quieres: 0:sin leche, 1:Normal, 2:Leche de Soya o 3:Leche de Almendras"
  );
